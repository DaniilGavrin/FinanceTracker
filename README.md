...
!!!Внимание к сожалению проект был переведём в режим TBA. Проект будет продолжен и развит но когда именно не понятно. Связано это с огромным количеством проблем, и также не хватки финансирования проекта, банковская система СНГ стран закрыта полностью и сделать приложение точным не представляется возможным, мы сделали всё что смогли и кредиты работают корректно как и большинство функционала, но из-за отсутствия доступа к банкам СНГ и их формулам, а также невозможности получить API или экспорт/импорт операций с банка в приложение сделать наше приложение точным не представляется возможным на момент 23.06.2026. А делать его не точным мы не хотим.

Возможно спустя время мы вернёмся с новыми силами и новыми знаниями в финтех пространстве СНГ и сделаем то что планировали изначально, может перепишет к тому времени всё на Tauri V2 или выше когда он будет стабильным к тому времени для всех систем, что будет дальше не знаем даже мы, но и это и не полное закрытие проекта. До скорых встреч и новых проектов.